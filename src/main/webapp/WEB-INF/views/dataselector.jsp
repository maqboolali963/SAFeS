...
$(document).ready(function(){
	...
	$.ajax({
	    ...
	    success : function(data) {
	        var schematitle='<b>Schema Title : <font size="4" color="#004584">'+data.schema_name+ '</font></b><br><br>(Note: Please select the parameters required for decision making) ';
	 		...
	 		var request = $.ajax({
				...
				success : function(response) {
					...
					var headerrowHTML='<tr><td style="border-style: solid; border-width: 1px" vertical-align:middle" align="center"><font face="Times New Roman" size="3" color="#004584"><b>Feature Name</b></font></td>';
				   	...
				   	tableHTML = tabletitleHTML + '<table border="2" width="100%" style="width: 50%" bordercolor="#004584">' + headerrowHTML + datarowsHTML + '</table>';
  ...
  <TR>
    ...
    <TABLE align=center border=2 borderColor=#39597d cellPadding=5 cellSpacing=5 width="82%">
		...
		<div align="center">
		     	...
		     	<p class="bg-info"><b>For loading of diabetes schema, click <font color="#004584"><i>'Load Schema'</i></font> button.</b></p>
				<br>
