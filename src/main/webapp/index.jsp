    ...
    <TABLE align=center border=2 borderColor=#39597d width="82%">
		...
		<div align="center">
		     	...
		     	<div class="col-md-8 col-md-offset-1" align="left" ><b>Data Driven Knowledge Acquisition Tool</b> 
						(DDKAT) is an web-based application that curates the knowledge using data-driven approach. This tool is designed for Mining Minds (MM) Platform and covers the data-driven part for Knowledge Curation Layer (KCL).<br><br>
						DDKAT acquires the data, preprocesses it, selects the decision trees algorithm, generates the classification model, and finally, produces the production rules. The main features include <b>Semi-Automatic Features Selection</b>, <b>Basic Preprocessing</b>, <b>Generation of Classification Model</b>, and <b>Creation of Production Rules from Classification Model</b>.</div>
