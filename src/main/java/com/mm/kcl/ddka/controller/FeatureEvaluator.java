...
/**
* This class executes the EFRS methodology.
*/
/**
 * @author M-Ali
 *
...
public class FeatureEvaluator {
	...
	public FeatureEvaluator(String json, Instances data) throws Exception {
        ...
        File file=new File("D:\\DDKAResources\\FeaturesEvaluationDataSet.csv");
        ...
        loader.setSource(new File("D:\\DDKAResources\\FeaturesEvaluationDataSet.csv"));
